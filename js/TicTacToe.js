...
function placeXOrO(squareNumber){
    ...
    //see if it contains the square numner clicked on.
    if(!selectedSquares.some(element=>element.includes(squareNumber))){
        ...
        //squareNumber and activePlayer are concatenated together and addes to array
        selectedSquares.push(squareNumber+activePlayer);
        //This calls a function to check for any win conditions.
        checkWinConditions();
        //This condition is for changing the active player.
        if(activePlayer==='X'){
            //if active playr is 'X' change it to 'o'
            activePlayer='O';
    ...
    function checkWinConditions(){
     ...
     //This function checks fi an array includes 3 strings
     ...
     function arrayIncludes(squareA,squareB,squareC){
         ...
         //If the 3 variables we pass are all included inpur array true is
    ...
    function disableClick(){
        ...
        //This makes our body clickable agai after 1 second
    ...
    function drawWinLine(coordX1, coordY1, coordX2, coordY2){
        ...
        //This function clears our canvas after our win line
        function clear(){
        ...
        //this line calls our main animtaion loop
        animateLineDrawing();
        //This line waits 1 sec
        //Then,clears canvas, resetss game, and allows clicking again
        setTimeout(function(){clear();resetGame();},1000)
    }

    //This function resets the game in a tie or a win
    function resetGame(){
        //This for lop iterates through each HTML square element
        for(let i=0; i<9; i++){
            //This variable gets the html element of i
            let square=document.getElementById(String(i));
            //this removes our elemebts backgroundImage
